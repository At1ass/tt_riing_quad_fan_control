#ifndef __RAINBOW_COLOR_COMMAND_HPP__
#define __RAINBOW_COLOR_COMMAND_HPP__
...
class RainbowColorCommand : public EffectCommand {
    using Color = std::array<uint8_t, 3>;

   public:
    explicit RainbowColorCommand(std::chrono::steady_clock::duration duration)
...
#endif  // !__RAINBOW_COLOR_COMMAND_HPP__
